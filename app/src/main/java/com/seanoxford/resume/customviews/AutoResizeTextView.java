...
public class AutoResizeTextView extends TextView {
    ...
    private boolean mFirstMeasured = false;
    ...
    private void adjustTextSize(String string) {
        ...
        mResult = efficientTextSizeSearch(startSize, (int) mMaxTextSize,
    ...
    protected void onSizeChanged(int width, int height, int oldwidth,
        ...
        if ((width != oldwidth || height != oldheight) && !mFirstMeasured) {
            reAdjust();
            mFirstMeasured = true;
...
//                mPaint = getPaint();
//                mPaint.getTextBounds(getText().toString(), 0, getText().toString().length(), mRect);
//            }
        }
    }
